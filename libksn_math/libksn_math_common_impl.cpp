...
//	T D = b * b;
//	D -= c;
//	if ( ::fabsl(D) < ::powl( 10, int(::log10(c > 0 ? c : -c)) - LDBL_DIG + 1 ) ) //If D is really close to 0
//	{
//		D = 0;
//	}
//	if (D < 0)
...
//
//static complex get_lambertW_initial_point(complex z, int k)
//{
...
//}
//
//static complex zexpz(complex z)
//{
//	return z * exp(z);
//}
//static long double zexpz(long double z)
//{
//	return z * ::expl(z);
//}
//
////The derivative of z * ::expl(z) = exp(z) + z * exp(z) = e^z * (z + 1)
//static complex zexpz_d(complex z)
//{
//	return exp(z) + z * exp(z);
//}
//static long double zexpz_d(long double z)
//{
//	return ::expl(z) + z * ::expl(z);
//}
//
////The second derivative of z * exp(z) = 2 * exp (z) + z * exp(z) = e^z * (z + 2)
//static complex zexpz_dd(complex z)
//{
//	return 2 * exp(z) + z * exp(z);
//}
//static long double zexpz_dd(long double z)
//{
