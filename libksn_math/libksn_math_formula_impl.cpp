...
struct _formula_initializator
{
	...
	_formula_initializator()
	{
		...
		const size_t constants_trie_nodes = 12, functions_trie_nodes = 49;

		const size_t constants_trie_size = constants_trie_nodes * sizeof(_trie_entry);
		const size_t functions_trie_size = functions_trie_nodes * sizeof(_trie_entry);

		const size_t allocation_size = constants_trie_size + functions_trie_size + 256;
