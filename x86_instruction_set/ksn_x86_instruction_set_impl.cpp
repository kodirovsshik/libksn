...
static int __ksn_get_cpuid_available_i386()
{
	...
	else
	{
		...
		static constexpr size_t id_flag = 1 << 21;
...
static bool init_feature_struct1(detail::__ksn_x86_64_features* pf)
{
	if (!_cpuid_supported)
	{
...
static int initializer()
{
	...
	if ((	
		registers.ebx == 0x68747541 && //"AuthenticAMD"
