...
struct __ksn_x86_64_features
{
	...
	bool smx : 1; //Safer Mode Extensions. A value of 1 indicates that the processor supports this technology. See Chapter 6, 鉄afer Mode Extensions Reference・
	bool est : 1; //Enhanced Intel SpeedStepｮ technology. A value of 1 indicates that the processor supports this technology.
	...
	bool cmpxchg16b : 1; //CMPXCHG16B Available. A value of 1 indicates that the feature is available. See the 鼎MPXCHG8B/CMPXCHG16B佑ompare and Exchange Bytes・section in this chapter for a description.
	...
	bool tsc_deadline : 1; //A value of 1 indicates that the processor痴 local APIC timer supports one-shot operation using a TSC deadline value.
